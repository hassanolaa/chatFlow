...
class SignInScreenTop extends StatefulWidget {
  const SignInScreenTop({super.key});

  @override
  State<SignInScreenTop> createState() => _SignInScreenTopState();
}

class _SignInScreenTopState extends State<SignInScreenTop> {
  String? email;
  String? pass;
