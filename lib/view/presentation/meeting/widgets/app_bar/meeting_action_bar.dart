    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          // TouchRippleEffect(
          //   borderRadius: BorderRadius.circular(12),
          //   rippleColor: isMicEnabled ? Appcolors.primaryColor : Colors.white,
          //   onTap: onMicButtonPressed,
          //   child: Container(
          //     decoration: BoxDecoration(
          //       borderRadius: BorderRadius.circular(12),
          //       border: Border.all(color: Appcolors.secondaryColor),
          //       color: isMicEnabled ? Appcolors.primaryColor : Colors.white,
          //     ),
          //     padding: const EdgeInsets.all(8),
          //     child: Row(
          //       children: [
          ...
          //           size: 30,
          //           color: isMicEnabled ? Colors.white : Appcolors.primaryColor,
          //         ),
          //         GestureDetector(
          //             onTapDown: (details) =>
          ...
          //       borderRadius: BorderRadius.circular(12),
          //       border: Border.all(color: Appcolors.secondaryColor),
          //       color: isCamEnabled ? Appcolors.primaryColor : Colors.white,
          //     ),
          ...
          //       width: 26,
          //       height: 26,
          //       color: isCamEnabled ? Colors.white : Appcolors.primaryColor,
          //     ),
          //   ),
          // ),
          ...
          PopupMenuButton(
              ...
              itemBuilder: (context) => <PopupMenuEntry>[
                    ...
                    _buildMeetingPoupItem(
                      ...
                      "Draw",
                      null,
                        Icon(Icons.draw, color: Colors.white, size: 30),
                    ),
                  ]),
        ],
      ),
          ...
          children: [
            ...
            if (description != null)
              Text(
                description,
                style:  TextStyle(
                    fontSize: 12, fontWeight: FontWeight.w500, color: Appcolors.fontcolor),
              )
          ],
        )
      ]),
