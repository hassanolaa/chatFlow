  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: Appcolors.black900, borderRadius: BorderRadius.circular(10)),
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            padding: const EdgeInsets.all(6),
            decoration: BoxDecoration(
              color: audioStream != null ? Appcolors.black900 : Colors.red,
              border: Border.all(color: audioStream != null ? Appcolors.black900 : Colors.red),
              borderRadius: BorderRadius.circular(30),
            ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: videoStream != null ? Appcolors.black900 : Colors.red,
              border: Border.all(color: videoStream != null ?Appcolors.black900 : Colors.red),
              borderRadius: BorderRadius.circular(30),
            ),
