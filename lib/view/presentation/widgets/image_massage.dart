...
class image_massage extends StatefulWidget {
   image_massage({super.key,required this.username,required this.time,required this.massage,required this.imageUrl,
      required this.seen,required this.massageid,
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child:Image(image: NetworkImage(widget.massage),fit: BoxFit.cover,)
                    ),
                  ),
                ],
              ),
